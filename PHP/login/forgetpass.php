...
function sendRecoveryLink($token, $email, $username){
    ...
    try {
        ...
        $mail->Body    = 'A request has been generated to reset your password. Please <b><a href="http://localhost:82/2309b2/login/resetpass.php?token='.$token.'&email='.$email.'">Click here</a></b> to reset your password.';
